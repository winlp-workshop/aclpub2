...
def main(username, password, venue, download_all, download_pdfs):
    ...
    for submission in tqdm(submissions):
        ...
        if "paper_length" in submission.content:
            paper_length = get_content_from(submission, "paper_length")
        else:
            paper_length = "N/A"

        if "submission_type" in submission.content:
            submission_type = get_content_from(submission, "submission_type")
        else:
            submission_type = "N/A"
        ...
        archival = get_content_from(submission, "archival") if "archival" in submission.content else "N/A"
        archival = True if archival == "Archival" else False
        paper["archival"] = archival
